...
public class Main {
    ...
    public static int calculateScore(String playerName, int score) { //unique method signature
...
//    public static void calculateScore() { not a unique method signature just by changing the data type
//        System.out.println("No player name, no player score.");
//    }
